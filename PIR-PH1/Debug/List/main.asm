...
; 0000 0008 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=Out Bit0=Out
; 0000 0009 DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(3)
	OUT  0x1A,R30
; 0000 000A // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=0 Bit0=0
...
; 0000 000F DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (0<<DDB3) | (0<<DDB2) | (1<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(2)
	OUT  0x17,R30
...
; 0000 0022 // Mode: Normal top=0xFF
; 0000 0023 // OC0 output: Disconnected
; 0000 0024 TCCR0=(0<<WGM00) | (0<<COM01) | (0<<COM00) | (0<<WGM01) | (0<<CS02) | (0<<CS01) | (0<<CS00);
	OUT  0x33,R30
...
; 0000 002A // Clock value: Timer1 Stopped
...
; 0000 003D OCR1BL=0x00;
	OUT  0x28,R30
; 0000 003E 
; 0000 003F // Timer/Counter 2 initialization
; 0000 0040 // Clock source: System Clock
; 0000 0041 // Clock value: Timer2 Stopped
; 0000 0042 // Mode: Normal top=0xFF
; 0000 0043 // OC2 output: Disconnected
...
; 0000 0054 // USART disabled
; 0000 0055 UCSRB=(0<<RXCIE) | (0<<TXCIE) | (0<<UDRIE) | (0<<RXEN) | (0<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	OUT  0xA,R30
; 0000 0056 
; 0000 0057 // Analog Comparator initialization
; 0000 0058 // Analog Comparator: Off
; 0000 0059 // The Analog Comparator's positive input is
; 0000 005A // connected to the AIN0 pin
; 0000 005B // The Analog Comparator's negative input is
; 0000 005C // connected to the AIN1 pin
...
; 0000 0065 // SPI disabled
; 0000 0066 SPCR=(0<<SPIE) | (0<<SPE) | (0<<DORD) | (0<<MSTR) | (0<<CPOL) | (0<<CPHA) | (0<<SPR1) | (0<<SPR0);
	OUT  0xD,R30
; 0000 0067 
; 0000 0068 // TWI initialization
; 0000 0069 // TWI disabled
; 0000 006A TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 006B 
; 0000 006C while (1)
_0x3:
; 0000 006D       {
; 0000 006E         if (PIND & (1 << PORTD7))
	SBIS 0x10,7
	RJMP _0x6
; 0000 006F             PORTB |= (1 << PORTB1 );
	SBI  0x18,1
; 0000 0070         else
	RJMP _0x7
_0x6:
; 0000 0071             PORTB &= ~(1 << PORTB1 );
	CBI  0x18,1
; 0000 0072       }
_0x7:
	RJMP _0x3
