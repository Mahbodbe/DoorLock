...
; 0000 002C // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=Out Bit0=Out
; 0000 002D DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (0<<DDB3) | (0<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(3)
	OUT  0x17,R30
; 0000 002E // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=0 Bit0=0
...
; 0000 0039 DDRD=(0<<DDD7) | (1<<DDD6) | (1<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	LDI  R30,LOW(96)
	OUT  0x11,R30
...
; 0000 006C // INT1: Off
; 0000 006D // INT2: On
; 0000 006E // INT2 Mode: Falling Edge
; 0000 006F GICR|=(0<<INT1) | (0<<INT0) | (1<<INT2);
	IN   R30,0x3B
	ORI  R30,0x20
	OUT  0x3B,R30
...
; 0000 0071 MCUCSR=(0<<ISC2);
	OUT  0x34,R30
; 0000 0072 GIFR=(0<<INTF1) | (0<<INTF0) | (1<<INTF2);
	LDI  R30,LOW(32)
	OUT  0x3A,R30
; 0000 0073 
...
; 0000 0081 // ADC Clock frequency: 125.000 kHz
; 0000 0082 // ADC Voltage Reference: AVCC pin
; 0000 0083 // ADC Auto Trigger Source: ADC Stopped
; 0000 0084 ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(64)
	OUT  0x7,R30
; 0000 0085 ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (1<<ADPS2) | (1<<ADPS1) | (0<<ADPS0);
	LDI  R30,LOW(134)
	OUT  0x6,R30
; 0000 0086 SFIOR=(0<<ADTS2) | (0<<ADTS1) | (0<<ADTS0);
	LDI  R30,LOW(0)
	OUT  0x30,R30
; 0000 0087 
...
; 0000 0095       if(control == 1){
	...
	BREQ PC+2
	RJMP _0xB
; 0000 0096         unsigned int v = read_adc(0);
; 0000 0097         PORTB |= (1 << PORTB0);
	SBIW R28,2
;	v -> Y+0
	LDI  R26,LOW(0)
	RCALL _read_adc
	...
	STD  Y+1,R31
	SBI  0x18,0
; 0000 0098         if(counter == 1){
	LDI  R30,LOW(1)
	LDI  R31,HIGH(1)
	CP   R30,R6
	CPC  R31,R7
	BRNE _0xC
; 0000 0099             PORTB |= ( PORTB1 << 1);
	SBI  0x18,1
; 0000 009A             delay_ms(10);
	LDI  R26,LOW(10)
	LDI  R27,0
	CALL _delay_ms
; 0000 009B             PORTB &= ~(PORTB1 << 1);
	CBI  0x18,1
; 0000 009C             counter = 0;
	CLR  R6
	CLR  R7
...
; 0000 00A0         if(v > 500){
	...
	CPC  R27,R30
	BRLO _0xD
; 0000 00A1             PORTB |= (PORTB1 << 1);
	SBI  0x18,1
; 0000 00A2             PORTD |= (1 << PORTD5);
	SBI  0x12,5
; 0000 00A3             isBuzz1 = 1;
	LDI  R30,LOW(1)
	LDI  R31,HIGH(1)
...
; 0000 00A5         else{
	RJMP _0xE
_0xD:
; 0000 00A6             PORTB &= ~(PORTB1 << 1);
	CBI  0x18,1
; 0000 00A7             if(isBuzz2 == 0)
	MOV  R0,R10
	OR   R0,R11
	BRNE _0xF
; 0000 00A8                 PORTD &= ~(1 << PORTD5);
	CBI  0x12,5
; 0000 00A9             isBuzz1 = 0;
_0xF:
	CLR  R8
...
_0xE:
; 0000 00AB 
; 0000 00AC         if (PIND & (1 << PORTD7)){
	SBIS 0x10,7
	RJMP _0x10
; 0000 00AD             PORTD |= (1 << PORTD6);
	SBI  0x12,6
; 0000 00AE             PORTD |= (1 << PORTD5);
	SBI  0x12,5
; 0000 00AF             isBuzz2 = 1;
	LDI  R30,LOW(1)
	LDI  R31,HIGH(1)
...
_0x10:
; 0000 00B2             {
; 0000 00B3             PORTD &= ~(1 << PORTD6);
	CBI  0x12,6
; 0000 00B4             if (isBuzz1 == 0)
	MOV  R0,R8
	OR   R0,R9
	BRNE _0x12
; 0000 00B5                 PORTD &= ~(1 << PORTD5 );
	CBI  0x12,5
; 0000 00B6             isBuzz2 = 0;
_0x12:
	CLR  R10
...
; 0000 00BB       else{
	RJMP _0x13
_0xB:
; 0000 00BC         PORTB &= ~(PORTB1 << 1);
	CBI  0x18,1
; 0000 00BD         PORTB &= ~(1 << PORTB0);
	CBI  0x18,0
; 0000 00BE         PORTD &= ~(1 << PORTD5);
	CBI  0x12,5
; 0000 00BF         PORTB &= ~(1 << PORTD6);
	CBI  0x18,6
; 0000 00C0 
; 0000 00C1       }
_0x13:
