...
; 0000 002A // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=Out Bit0=Out
; 0000 002B DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (0<<DDB3) | (0<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(3)
	OUT  0x17,R30
; 0000 002C // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=0 Bit0=0
...
; 0000 006A // INT1: Off
; 0000 006B // INT2: On
; 0000 006C // INT2 Mode: Falling Edge
; 0000 006D GICR|=(0<<INT1) | (0<<INT0) | (1<<INT2);
	IN   R30,0x3B
	ORI  R30,0x20
	OUT  0x3B,R30
...
; 0000 006F MCUCSR=(0<<ISC2);
	OUT  0x34,R30
; 0000 0070 GIFR=(0<<INTF1) | (0<<INTF0) | (1<<INTF2);
	LDI  R30,LOW(32)
	OUT  0x3A,R30
; 0000 0071 
...
; 0000 007F // ADC Clock frequency: 125.000 kHz
; 0000 0080 // ADC Voltage Reference: AVCC pin
; 0000 0081 // ADC Auto Trigger Source: ADC Stopped
; 0000 0082 ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(64)
	OUT  0x7,R30
; 0000 0083 ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (1<<ADPS2) | (1<<ADPS1) | (0<<ADPS0);
	LDI  R30,LOW(134)
	OUT  0x6,R30
; 0000 0084 SFIOR=(0<<ADTS2) | (0<<ADTS1) | (0<<ADTS0);
	LDI  R30,LOW(0)
	OUT  0x30,R30
; 0000 0085 
...
_0x8:
; 0000 0092       {
; 0000 0093       if(control == 1){
	LDI  R30,LOW(1)
	LDI  R31,HIGH(1)
	CP   R30,R4
	CPC  R31,R5
	BRNE _0xB
; 0000 0094         unsigned int v = read_adc(0);
; 0000 0095         PORTB |= (1 << PORTB0);
	SBIW R28,2
;	v -> Y+0
	LDI  R26,LOW(0)
	RCALL _read_adc
	...
	STD  Y+1,R31
	SBI  0x18,0
; 0000 0096         if(counter == 1){
	LDI  R30,LOW(1)
	LDI  R31,HIGH(1)
	CP   R30,R6
	CPC  R31,R7
	BRNE _0xC
; 0000 0097             PORTB |= ( PORTB1 << 1);
	SBI  0x18,1
