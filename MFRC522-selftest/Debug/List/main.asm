...
_0x0:
	...
	.DB  0x74,0x3A,0x20,0x50,0x41,0x53,0x53,0x0
	.DB  0x53,0x65,0x6C,0x66,0x54,0x65,0x73,0x74
	.DB  0x3A,0x20,0x46,0x41,0x49,0x4C,0x0
_0x2000003:
	.DB  0x80,0xC0

__GLOBAL_INI_TBL:
	.DW  0x40
	.DW  _expect_v10_S0000007000
	.DW  _0x9*2

	.DW  0x40
	.DW  _expect_v20_S0000007000
	.DW  _0xA*2
...
_0x12:
	...
	ST   -Y,R30
	LDI  R26,LOW(64)
	RCALL _rc522_fifo_read_bytes_G000
...
_0x15:
	...
	BRSH _0x16
	CALL SUBOPT_0x2
	SUBI R30,LOW(-_expect_v10_S0000007000)
	SBCI R31,HIGH(-_expect_v10_S0000007000)
	LD   R30,Z
	CP   R30,R26
	BREQ _0x17
	LDI  R30,LOW(0)
...
_0x1B:
	...
	BRSH _0x1C
	CALL SUBOPT_0x2
	SUBI R30,LOW(-_expect_v20_S0000007000)
	SBCI R31,HIGH(-_expect_v20_S0000007000)
	LD   R30,Z
	CP   R30,R26
	BREQ _0x1D
	LDI  R30,LOW(0)
