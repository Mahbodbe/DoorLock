...
;
;int ChooseMenu(void){
; 0000 0011 int ChooseMenu(void){

	.CSEG
_ChooseMenu:
; .FSTART _ChooseMenu
; 0000 0012     if (controlMenu == 0){
	LDS  R30,_controlMenu
	CPI  R30,0
	BRNE _0x3
; 0000 0013         if (selectorT == 0){
	LDS  R30,_selectorT
	CPI  R30,0
	BRNE _0x4
; 0000 0014             lcd_clear();
	CALL SUBOPT_0x0
; 0000 0015             lcd_gotoxy(0,0); lcd_putsf(">DisArm");
	__POINTW2FN _0x0,0
	CALL SUBOPT_0x1
; 0000 0016             lcd_gotoxy(0,1); lcd_putsf("Arm");
	__POINTW2FN _0x0,4
	CALL _lcd_putsf
; 0000 0017             return 0;
	LDI  R30,LOW(0)
...
; 0000 0022             lcd_clear();
	CALL SUBOPT_0x0
; 0000 0023             lcd_gotoxy(0,0); lcd_putsf(">Laser sense");
	__POINTW2FN _0x0,13
	CALL SUBOPT_0x1
; 0000 0024             lcd_gotoxy(0,1); lcd_putsf("Movement sense");
	__POINTW2FN _0x0,26
	CALL _lcd_putsf
; 0000 0025             return 2;
	LDI  R30,LOW(2)
...
; 0000 0028             lcd_clear();
	CALL SUBOPT_0x0
; 0000 0029             lcd_gotoxy(0,0); lcd_putsf("Laser sense");
	__POINTW2FN _0x0,14
	CALL SUBOPT_0x1
; 0000 002A             lcd_gotoxy(0,1); lcd_putsf(">Movement sense");
	__POINTW2FN _0x0,41
	CALL _lcd_putsf
; 0000 002B             return 3;
	LDI  R30,LOW(3)
...
; 0000 002E             lcd_clear();
	CALL SUBOPT_0x0
; 0000 002F             lcd_gotoxy(0,0); lcd_putsf("Movement sense");
	__POINTW2FN _0x0,26
	CALL SUBOPT_0x1
; 0000 0030             lcd_gotoxy(0,1); lcd_putsf(">Both");
	__POINTW2FN _0x0,57
	CALL _lcd_putsf
; 0000 0031             return 4;
	LDI  R30,LOW(4)
...
;	v -> Y+0
	...
	CPC  R27,R30
	BRLT _0xE
; 0000 003C         PORTB |= (PORTB1 << 1);
	SBI  0x18,1
; 0000 003D         PORTD |= (1 << PORTD5);
	SBI  0x12,5
; 0000 003E         isBuzz1 = 1;
	LDI  R30,LOW(1)
	RJMP _0x31
...
; 0000 0040     else{
_0xE:
; 0000 0041         PORTB &= ~(PORTB1 << 1);
	CBI  0x18,1
; 0000 0042         if(isBuzz2 == 0)
	LDS  R30,_isBuzz2
	CPI  R30,0
	BRNE _0x10
; 0000 0043             PORTD &= ~(1 << PORTD5);
	CBI  0x12,5
; 0000 0044         isBuzz1 = 0;
_0x10:
	LDI  R30,LOW(0)
...
;
;void PIR(void) {
; 0000 0049 void PIR(void) {
_PIR:
; .FSTART _PIR
; 0000 004A 
; 0000 004B     if (PIND & (1 << PORTD7)){
	SBIS 0x10,7
	RJMP _0x11
; 0000 004C         PORTD |= (1 << PORTD6);
	SBI  0x12,6
