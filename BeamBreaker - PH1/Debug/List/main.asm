...
; 0000 001B // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=Out Bit0=In
; 0000 001C DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (0<<DDB3) | (0<<DDB2) | (1<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(2)
	OUT  0x17,R30
; 0000 001D // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=0 Bit0=T
...
; 0000 006D // ADC Clock frequency: 125.000 kHz
; 0000 006E // ADC Voltage Reference: AVCC pin
; 0000 006F // ADC Auto Trigger Source: ADC Stopped
; 0000 0070 ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(64)
	OUT  0x7,R30
; 0000 0071 ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (1<<ADPS2) | (1<<ADPS1) | (0<<ADPS0);
	LDI  R30,LOW(134)
	OUT  0x6,R30
...
_0x6:
; 0000 007D       {
; 0000 007E         unsigned int v = read_adc(0);
; 0000 007F         if(v > 500)
	SBIW R28,2
;	v -> Y+0
	LDI  R26,LOW(0)
	...
	CPC  R27,R30
	BRLO _0x9
; 0000 0080             PORTB |= (PORTB1 << 1);
	SBI  0x18,1
; 0000 0081         else
	RJMP _0xA
_0x9:
; 0000 0082             PORTB &= ~(PORTB1 << 1);
	CBI  0x18,1
; 0000 0083 
