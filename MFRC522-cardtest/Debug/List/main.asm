...
_0x0:
	...
	.DB  0x3A,0x20,0x50,0x41,0x53,0x53,0x0,0x43
	.DB  0x61,0x72,0x64,0x20,0x64,0x65,0x74,0x65
	.DB  0x63,0x74,0x65,0x64,0x21,0x0,0x55,0x49
	.DB  0x44,0x3A,0x25,0x30,0x32,0x58,0x25,0x30
	.DB  0x32,0x58,0x25,0x30,0x32,0x58,0x25,0x30
	.DB  0x32,0x58,0x0,0x55,0x49,0x44,0x20,0x63
	.DB  0x6F,0x6E,0x74,0x2E,0x3A,0x0,0x53,0x65
	.DB  0x61,0x72,0x63,0x68,0x69,0x6E,0x67,0x20
	.DB  0x63,0x61,0x72,0x64,0x0,0x4E,0x4F,0x20
	.DB  0x43,0x41,0x52,0x44,0x20,0x20,0x20,0x20
...
; 0000 016F             lcd_putchar(spch[spin++ & 3]);
	LDS  R26,_spin_S000000E002
	SUBI R26,-LOW(1)
	STS  _spin_S000000E002,R26
	SUBI R26,LOW(1)
	LDI  R30,LOW(3)
	AND  R30,R26
	LDI  R31,0
	SUBI R30,LOW(-_spch_S000000E002)
	SBCI R31,HIGH(-_spch_S000000E002)
	LD   R26,Z
	RCALL _lcd_putchar
; 0000 0170 
...
; 0000 0177             ms_acc += 150;
	LDS  R30,_ms_acc_S000000E002
	LDS  R31,_ms_acc_S000000E002+1
	SUBI R30,LOW(-150)
	SBCI R31,HIGH(-150)
	STS  _ms_acc_S000000E002,R30
	STS  _ms_acc_S000000E002+1,R31
; 0000 0178             if(ms_acc >= 1500){
	LDS  R26,_ms_acc_S000000E002
	LDS  R27,_ms_acc_S000000E002+1
	CPI  R26,LOW(0x5DC)
	LDI  R30,HIGH(0x5DC)
	CPC  R27,R30
	BRLO _0x4A
