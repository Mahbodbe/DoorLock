...
این پروژه یک سیستم امنیتی و قفل هوشمند است که با استفاده از ماژول‌های الکترونیکی مختلف توسعه داده شده است. هدف این پروژه ایجاد یک سیستم دسترسی یکپارچه و ایمن با قابلیت تشخیص کاربر و حرکت محیطی است.
